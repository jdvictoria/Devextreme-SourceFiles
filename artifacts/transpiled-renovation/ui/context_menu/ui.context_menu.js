...
let ContextMenu = /*#__PURE__*/function (_MenuBase) {
  ...
  _proto._scrollToElement = function _scrollToElement($element) {
    const $scrollableElement = $element.closest(".".concat(SCROLLABLE_CLASS));
  ...
  _proto._renderSubmenuItems = function _renderSubmenuItems(node, $itemFrame) {
    ...
    const $submenu = $itemFrame.children(".".concat(DX_SUBMENU_CLASS));
  ...
  _proto._initScrollable = function _initScrollable($container) {
  ...
  _proto._setSubMenuHeight = function _setSubMenuHeight($submenu, anchor, isNestedSubmenu) {
    const $itemsContainer = $submenu.find(".".concat(DX_MENU_ITEMS_CONTAINER_CLASS));
  ...
  _proto._getMaxHeight = function _getMaxHeight(anchor) {
  ...
  _proto._dimensionChanged = function _dimensionChanged() {
    ...
    this._shownSubmenus.forEach($submenu => {
      const $item = $submenu.closest(".".concat(DX_MENU_ITEM_CLASS));
  ...
  _proto._getSubmenuBorderWidth = function _getSubmenuBorderWidth() {
  ...
  _proto._showSubmenu = function _showSubmenu($item) {
    ...
    let $submenu = $item.children(".".concat(DX_SUBMENU_CLASS));
  ...
  _proto._show = function _show(event) {
    ...
    if (position) {
      ...
      const $subMenu = (0, _renderer.default)(this._overlay.content()).children(".".concat(DX_SUBMENU_CLASS));
      ...
      this._overlay.option({
        ...
        maxHeight: () => {
          const $content = $subMenu.find(".".concat(DX_MENU_ITEMS_CONTAINER_CLASS));
  ...
  _proto._renderItems = function _renderItems(nodes, submenuContainer) {
    _MenuBase.prototype._renderItems.call(this, nodes, submenuContainer);
    const $submenu = (0, _renderer.default)(this._overlay.content()).children(".".concat(DX_SUBMENU_CLASS));
    if ($submenu.length) {
      this._initScrollable($submenu);
    }
