...
const stateStoring = Base => /*#__PURE__*/function (_stateStoringModule$e) {
  ...
  _proto.applyState = function applyState(state) {
...
const data = Base => /*#__PURE__*/function (_stateStoringModule$e2) {
  ...
  _proto2.getUserState = function getUserState() {
