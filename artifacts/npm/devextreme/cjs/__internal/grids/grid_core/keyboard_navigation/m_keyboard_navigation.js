...
let KeyboardNavigationController = exports.KeyboardNavigationController = /*#__PURE__*/function (_modules$ViewControll) {
  ...
  _proto.isInsideMasterDetail = function isInsideMasterDetail($target) {
    const $masterDetail = $target.closest(".".concat(_const2.MASTER_DETAIL_CELL_CLASS));
  ...
  _proto.focusFirstInteractiveElementInside = function focusFirstInteractiveElementInside($el) {
  ...
  */;
  ...
  _proto.getMasterDetailCell = function getMasterDetailCell(element) {
