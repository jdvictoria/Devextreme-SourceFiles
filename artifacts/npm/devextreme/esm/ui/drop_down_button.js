...
var DropDownButton = Widget.inherit({
  ...
  _initDataController() {
    ...
    this._dataController = new DataController(dataSource !== null && dataSource !== void 0 ? dataSource : this.option('items'), {
  ...
  _getButtonGroupItems() {
    ...
    var items = [this._getActionButtonConfig()];
    if (splitButton) {
  ...
  _updateDataController: function _updateDataController(items) {
