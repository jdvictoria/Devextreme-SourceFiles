...
class Menu extends MenuBase {
  ...
  _isTargetOutOfComponent(relatedTarget) {
    var isInsideRootMenu = $(relatedTarget).closest(".".concat(DX_MENU_CLASS)).length !== 0;
    var isInsideContextMenu = $(relatedTarget).closest(".".concat(DX_CONTEXT_MENU_CLASS)).length !== 0;
    var isTargetOutOfComponent = !(isInsideRootMenu || isInsideContextMenu);
  ...
  _submenuOnShowingHandler($menuAnchorItem, submenu, _ref) {
    ...
    var $border = $menuAnchorItem.children(".".concat(DX_CONTEXT_MENU_CONTAINER_BORDER_CLASS));
    var params = this._getVisibilityChangeEventParams(rootItem, submenu, $menuAnchorItem);
  ...
  _submenuOnHidingHandler($menuAnchorItem, submenu, eventArgs) {
    var $border = $menuAnchorItem.children(".".concat(DX_CONTEXT_MENU_CONTAINER_BORDER_CLASS));
    var params = this._getVisibilityChangeEventParams(eventArgs.rootItem, submenu, $menuAnchorItem, true);
  ...
  _submenuOnHiddenHandler($menuAnchorItem, submenu, _ref3) {
    ...
    var params = this._getVisibilityChangeEventParams(rootItem, submenu, $menuAnchorItem, true);
  ...
  _getVisibilityChangeEventParams(submenuItem, submenu, $menuAnchorItem, isHide) {
    ...
    if (submenuItem) {
      var anchor = isHide ? $(submenuItem).closest(".".concat(DX_MENU_ITEM_CLASS))[0] : submenuItem;
      itemData = this._getItemData(anchor);
      $submenuContainer = $(anchor).find(".".concat(DX_SUBMENU_CLASS)).first();
    } else {
