...
import { FORM_CLASS, FIELD_ITEM_CLASS, FORM_GROUP_CLASS, FORM_GROUP_CONTENT_CLASS, FIELD_ITEM_CONTENT_HAS_GROUP_CLASS, FIELD_ITEM_CONTENT_HAS_TABS_CLASS, FORM_GROUP_WITH_CAPTION_CLASS, FORM_GROUP_CAPTION_CLASS, FORM_GROUP_CUSTOM_CAPTION_CLASS, FIELD_ITEM_TAB_CLASS, FORM_FIELD_ITEM_COL_CLASS, GROUP_COL_COUNT_CLASS, GROUP_COL_COUNT_ATTR, FIELD_ITEM_CONTENT_CLASS, FORM_VALIDATION_SUMMARY, ROOT_SIMPLE_ITEM_CLASS, FORM_UNDERLINED_CLASS } from './constants';
...
var Form = Widget.inherit({
  ...
  _tryPrepareGroupItemCaption: function _tryPrepareGroupItemCaption(item) {
  ...
  _itemGroupCaptionTemplate: function _itemGroupCaptionTemplate(item, $group, id) {
    if (item.groupCaptionTemplate) {
      var $captionTemplate = $('<div>').addClass(FORM_GROUP_CUSTOM_CAPTION_CLASS).attr('id', id).appendTo($group);
  ...
  _itemGroupContentTemplate: function _itemGroupContentTemplate(item, $group) {
