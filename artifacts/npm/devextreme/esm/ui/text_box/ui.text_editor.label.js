...
class TextEditorLabel {
  ...
  _updateBeforeWidth() {
    if (this._isVisible()) {
      ...
      var width = (_this$_props$beforeWi = this._props.beforeWidth) !== null && _this$_props$beforeWi !== void 0 ? _this$_props$beforeWi : this._props.getBeforeWidth();
      this._$before.css({
        width
      });
  ...
  _updateMaxWidth() {
    if (this._isVisible() && !this._isOutsideMode()) {
      ...
      var maxWidth = (_this$_props$containe = this._props.containerWidth) !== null && _this$_props$containe !== void 0 ? _this$_props$containe : this._props.getContainerWidth();
      this._$label.css({
        maxWidth
      });
    }
