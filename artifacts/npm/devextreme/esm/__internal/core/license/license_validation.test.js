...
describe('license check', () => {
  ...
  test.each([{
    ...
    token: undefined,
    version: '1.2'
  }])('trial panel should be displayed if license is empty, preview or not', _ref3 => {
    var {
      token,
      version
    } = _ref3;
  ...
  test.each([{
    ...
    token: TOKEN_23_1,
    version: '123'
  }])('W0022 error should be logged if version is preview [%#]', _ref4 => {
    var {
      token,
      version
    } = _ref4;
  ...
  test.each([{
    ...
    token: TOKEN_23_2,
    version: '23.2.6'
  }])('No messages should be logged if license is valid', _ref5 => {
    var {
      token,
      version
    } = _ref5;
  ...
  test.each([{
    ...
    token: TOKEN_23_2,
    version: '23.2.6'
  }])('Trial panel should not be displayed if license is valid', _ref6 => {
    var {
      token,
      version
    } = _ref6;
  ...
  test.each([{
    ...
    token: TOKEN_23_2,
    version: '42.4.0'
  }])('Trial panel should be displayed if license is outdated (>=1 major for RTM, >=2 major for preview)', _ref8 => {
    var {
      token,
      version
    } = _ref8;
  ...
  test.each([{
    ...
    token: TOKEN_23_2,
    version: '24.1.abc'
  }])('Trial panel should not be displayed in previews if the license is for the previous RTM', _ref9 => {
    var {
      token,
      version
    } = _ref9;
