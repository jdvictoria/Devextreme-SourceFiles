...
export class FocusController extends core.ViewController {
  ...
  updateFocusedRow(e) {
    var _a;
    var that = this;
    var focusedRowIndex = (_a = e.focusedRowIndex) !== null && _a !== void 0 ? _a : that.getDataController().getRowIndexByKey(e.focusedRowKey);
...
var rowsView = Base => class RowsViewFocusController extends Base {
  ...
  _setFocusedRowElementTabIndex(preventScroll) {
    ...
    var operationTypes = dataSource === null || dataSource === void 0 ? void 0 : dataSource.operationTypes();
