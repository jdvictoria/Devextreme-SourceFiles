...
const BaseView = _ui.default.inherit({
  ...
  _getSingleModeAriaLabel() {
    ...
    const ariaLabel = "".concat(localizedWidgetName, ". ").concat(selectedDatesText);
    return ariaLabel;
  },
  _getRangeModeAriaLabel() {
    ...
    const selectedDatesText = startDate && endDate ? _message.default.format('dxCalendar-selectedDateRange', formattedStartDate, formattedEndDate) : _message.default.format('dxCalendar-selectedDate', formattedStartDate !== null && formattedStartDate !== void 0 ? formattedStartDate : formattedEndDate);
    const ariaLabel = "".concat(localizedWidgetName, ". ").concat(selectedDatesText);
    return ariaLabel;
  },
  ...
  getCellAriaLabel(date) {
    ...
    const ariaLabel = isToday ? "".concat(dateRangeText, ". ").concat(CURRENT_DATE_TEXT[viewName]) : dateRangeText;
    return ariaLabel;
  },
