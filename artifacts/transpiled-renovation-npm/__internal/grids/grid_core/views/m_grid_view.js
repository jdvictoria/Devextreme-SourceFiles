...
let ResizingController = exports.ResizingController = /*#__PURE__*/function (_modules$ViewControll) {
  ...
  _proto._setAriaLabel = function _setAriaLabel() {
    var _a, _b, _c;
    const columnCount = (_c = (_b = (_a = this._columnsController) === null || _a === void 0 ? void 0 : _a._columns) === null || _b === void 0 ? void 0 : _b.filter(_ref => {
      let {
        visible
      } = _ref;
      return !!visible;
    ...
    const $ariaLabelElement = this.component.$element().children(".".concat(GRIDBASE_CONTAINER_CLASS));
...
let GridView = exports.GridView = /*#__PURE__*/function (_modules$View) {
  ...
  _proto3.setWidgetA11yStatusText = function setWidgetA11yStatusText(statusText) {
    var _a;
