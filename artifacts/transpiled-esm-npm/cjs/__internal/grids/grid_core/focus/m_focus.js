...
let FocusController = exports.FocusController = /*#__PURE__*/function (_core$ViewController) {
  ...
  _proto.getKeyboardController = function getKeyboardController() {
  ...
  _proto.updateFocusedRow = function updateFocusedRow(e) {
    var _a;
    const that = this;
    const focusedRowIndex = (_a = e.focusedRowIndex) !== null && _a !== void 0 ? _a : that.getDataController().getRowIndexByKey(e.focusedRowKey);
