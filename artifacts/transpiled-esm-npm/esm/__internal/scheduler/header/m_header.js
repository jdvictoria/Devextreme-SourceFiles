...
export class SchedulerHeader extends Widget {
  ...
  _createEventMap() {
    this.eventMap = new Map([['currentView', [view => {
      this.currentView = viewsUtils.getCurrentView(getViewName(view),
      // @ts-expect-error
      this.option('views'));
    }]], ['items', [this.repaint.bind(this)]], ['views', [validateViews]], ['currentDate', [this._getCalendarOptionUpdater('value')]], ['min', [this._getCalendarOptionUpdater('min')]], ['max', [this._getCalendarOptionUpdater('max')]], ['tabIndex', [this.repaint.bind(this)]], ['focusStateEnabled', [this.repaint.bind(this)]], ['useDropDownViewSwitcher', [this.repaint.bind(this)]]]);
  }
  ...
  _init() {
    ...
    this.currentView = viewsUtils.getCurrentView(getViewName(this.option('currentView')),
    // @ts-expect-error
    this.option('views'));
  }
  _render() {
