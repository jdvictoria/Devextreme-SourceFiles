    ...
    if (args.name === 'toolbar') {
      ...
      if (parts.length === 1) {
        ...
        if (parts.length === 2) {
          ...
          (_a = this._toolbar) === null || _a === void 0 ? void 0 : _a.option('items', toolbarOptions.items);
        } else if (parts.length === 3) {
          // `toolbar.items[i]` case
          var normalizedItem = this._normalizeToolbarItems(this._getToolbarItems(), args.value);
          (_b = this._toolbar) === null || _b === void 0 ? void 0 : _b.option(optionName, normalizedItem);
        } else if (parts.length >= 4) {
          // `toolbar.items[i].prop` case
          (_c = this._toolbar) === null || _c === void 0 ? void 0 : _c.option(optionName, args.value);
        }
      } else {
