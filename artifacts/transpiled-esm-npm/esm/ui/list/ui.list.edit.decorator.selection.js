...
var DEFAULT_SELECT_ALL_ARIA_LABEL = messageLocalization.format('dxList-selectAll');
registerDecorator('selection', 'default', EditDecorator.inherit({
  ...
  _renderSelectAll() {
    ...
    var downArrowHandler = this._list._supportedKeys().downArrow.bind(this._list);
    var selectAllCheckBoxElement = $('<div>').addClass(SELECT_DECORATOR_SELECT_ALL_CHECKBOX_CLASS).appendTo(this._$selectAll);
  ...
  _updateSelectAllAriaLabel() {
    ...
    var indeterminate = value === undefined;
    var checkedText = indeterminate ? 'half checked' : value ? 'checked' : 'not checked';
    var label = "".concat(DEFAULT_SELECT_ALL_ARIA_LABEL, ", ").concat(checkedText);
